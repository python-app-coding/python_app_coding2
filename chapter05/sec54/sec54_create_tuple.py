...
#     ...
#     x[0] = 10
# TypeError: 'tuple' object does not support item assignment	# 元组对象不支持元素赋值
...
# >>> x[2] += [2]	# 将第2个元素进行+运算，改变了对象，将触发异常
# Traceback (most recent call last):
#   ......
# TypeError: 'tuple' object does not support item assignment  # 元组对象不支持元素修改
# >>> x	# 但元组的内容仍然发生了改变
# (1, 2, [10, 2])
...
【元组解包】
  ...
  # >>> a, *b, *c = range(5)	# 无法确定b和c的元素
  # ...
  # SyntaxError: multiple starred expressions in assignment	#语法错误：使用了多个*表达式
