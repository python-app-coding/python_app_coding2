...
module location: D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py

1. 在本目录以主程序运行
    [own directory]> python module

    (venv) D:\python_app_coding\chapter08--DirectoryManagement>python sec815_module_attrs.py
    Module status: run
    --------------------------------------------------------------------------------
    __file__:       D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    __name__:       __main__
    sys.argv[0]:    sec815_module_attrs.py
    sys.path[0]:    D:\python_app_coding\chapter08--DirectoryManagement
    --------------------------------------------------------------------------------

2. 在其他目录以主程序运行
    [other directory]> python module

    (venv) D:\python_app_coding>python chapter08--DirectoryManagement\sec815_module_attrs.py
    Module status: run
    --------------------------------------------------------------------------------
    __file__:       D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    __name__:       __main__
    sys.argv[0]:    chapter08--DirectoryManagement\sec815_module_attrs.py
    sys.path[0]:    D:\python_app_coding\chapter08--DirectoryManagement
    --------------------------------------------------------------------------------
...
3. 在本目录以模块方式运行
    ...
    (venv) D:\python_app_coding\chapter08--DirectoryManagement>python -m module_attrs
    Module status: run
    --------------------------------------------------------------------------------
    __file__:       D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    __name__:       __main__
    sys.argv[0]:    D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    sys.path[0]:    D:\python_app_coding\chapter08--DirectoryManagement
    __spec__.name:  module_attrs
    __spec__.parent:
    __spec__.origin:        D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    --------------------------------------------------------------------------------

4. 在其它目录以模块方式运行
    [other directory]> python -m module

    (venv) D:\python_app_coding>python -m chapter08--DirectoryManagement.module_attrs
    Module status: run
    --------------------------------------------------------------------------------
    __file__:       D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    __name__:       __main__
    ...
    __spec__.name:  chapter08--DirectoryManagement.module_attrs
    __spec__.parent:        chapter08--DirectoryManagement
    __spec__.origin:        D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    --------------------------------------------------------------------------------
...
6. 在其他目录导入 import zt orhter directory
    ...
    --------------------------------------------------------------------------------
    __file__:       D:\python_app_coding\chapter08--DirectoryManagement\sec815_module_attrs.py
    __name__:       chapter08--DirectoryManagement.module_attrs
    sys.argv[0]:
    sys.path[0]:
    __spec__.name:  chapter08--DirectoryManagement.module_attrs
    __spec__.parent:        chapter08--DirectoryManagement
