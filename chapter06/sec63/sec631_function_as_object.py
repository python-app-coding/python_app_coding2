...
print(isinstance(fun1, types.FunctionType))	    # fun是一个函数类型的对象，对象是在运行时创建的 True
...
# True
print(id(fun1), id(fvar))
# (1695124828912, 1695124828912)	# 变量的id为运行时动态确定，各次运行会不相同
