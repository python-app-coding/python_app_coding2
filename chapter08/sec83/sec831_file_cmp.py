...
def demo_filecmp():
    ...
    print(filecmp.cmp("work/cmpfile1.txt", "work/cmpfile2.txt"))
    # True
    print(filecmp.cmp("work/cmpfile1.txt", "work/cmpfile2.txt", shallow=False))
    # False
    print(filecmp.cmp("work/cmpfile1.txt", "work/cmpfile3.txt"))
    # True
    print(filecmp.cmp("work/cmpfile1.txt", "work/cmpfile3.txt", shallow=False))
    # True
